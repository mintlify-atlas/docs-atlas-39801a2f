---
title: "Install LWXGL on Linux"
sidebarTitle: "Installation"
description: "Build libLWXGL.so from source with g++ and Xlib, then install the shared library and header system-wide using make install."
---
