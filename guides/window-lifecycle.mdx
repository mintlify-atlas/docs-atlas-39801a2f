---
title: "Managing the LWXGL Window Lifecycle"
sidebarTitle: "Window Lifecycle"
description: "Learn how to create, drive, and tear down an LWXGL window using either GSimpleWindowLoop or a manual render loop."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Ctrl + Escape" icon="keyboard">
    Always closes the window unconditionally, bypassing any `GEventAttachDelete` callback.
  </Card>
</CardGroup>
