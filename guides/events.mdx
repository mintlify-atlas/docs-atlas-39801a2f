---
title: "Handling Keyboard and Mouse Events in LWXGL"
sidebarTitle: "Events"
description: "Attach callbacks for keypress, mouse click, and window close events, and poll real-time mouse and keyboard state in LWXGL."
---
...
- **Ctrl+Escape** — unconditionally closes the window.
