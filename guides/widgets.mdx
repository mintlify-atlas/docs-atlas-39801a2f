---
title: "Building UIs with LWXGL Widgets"
sidebarTitle: "Widgets"
description: "Create and manage text labels, buttons, text inputs, rectangles, and image canvases using LWXGL's integer-ID element system."
---
