---
title: "LWXGL Quickstart: Open an X11 Window and Add Widgets"
sidebarTitle: "Quickstart"
description: "Open an X11 window, add a text label and a button, handle events, and run the fixed-timestep loop in under 30 lines of C using LWXGL."
---
